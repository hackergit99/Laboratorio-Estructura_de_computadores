...
main:
    ...
    # Comparar los valores ingresados para encontrar el menor
    bge $t0, $t1, skip_t0_t1
    bge $t0, $t2, skip_t0_t2
    move $t3, $t0      # Si num1 es menor que num2 y num3, $t3 = num1
    j end

skip_t0_t2:
    move $t3, $t2      # Si num1 es mayor que num3, $t3 = num3
    j end

skip_t0_t1:
    bge $t1, $t2, skip_t1_t2
    move $t3, $t1      # Si num2 es menor que num1 y num3, $t3 = num2
    j end

skip_t1_t2:
    move $t3, $t2      # Si num2 es mayor que num3, $t3 = num3

end:
    # Guardar el número menor de los tres valores ingresados en result
    sw $t3, result     # Guarda el valor de $t3 (menor) en result

    # Mostrar mensaje y el número menor
